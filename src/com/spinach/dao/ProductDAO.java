...
public class ProductDAO extends HibernateDaoSupport {
	...
	public static final String PRICE_BOX = "priceBox";
	public static final String PRICE_BOTTLE = "priceBottle";
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding Product instance with property: " + propertyName
				+ ", value: " + value);
		try {
			String queryString = "from Product as model left join fetch model.type as t where model."
					+ propertyName + "= ?";
	...
	public List findByPriceBox(Object priceBox) {
		return findByProperty(PRICE_BOX, priceBox);
	}

	public List findByPriceBottle(Object priceBottle) {
		return findByProperty(PRICE_BOTTLE, priceBottle);
	}
