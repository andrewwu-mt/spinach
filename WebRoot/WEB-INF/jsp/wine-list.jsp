    ...
    <div class="col-xs-12  col-sm-9">
      <div class="grid">
        <ul class="pagination  shop__amount-filter">
          <li>
            <a class="shop__amount-filter__link  hidden-xs" href="wine-list"><span class="glyphicon glyphicon-th"></span></a>
          </li>
          <li>
              <a class="shop__amount-filter__link  hidden-xs" href="wine-list-view"><span class="glyphicon glyphicon-th-list"></span></a>
          </li>
        </ul>
        ...
        <s:iterator value="#request.productList">    
        	<s:if test="%{type.typeId == 2}">
              <div class="prod_list col-xs-6 col-sm-3 js--isotope-target  js--cat-${category.categoryId}" data-price="${priceBottle}" data-rating="5">
